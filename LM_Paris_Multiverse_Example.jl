...
l = @layout [a b]
plot(p1, p2, layout = l, size=(800,300), legendfontsize=lsize, legendfontfamily=myfont)


png("C:/Users/eduar/OneDrive - Aalborg Universitet/Research/CLIMATE/LM_Paris_Green_Paper/Volatility-persistence-brown-and-green-stocks-Paris-TandF-/figs/Multiverse_analysis_example.png")